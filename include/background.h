...
struct background
{
  ...
  double Omega_phi_ini_scf;        /**< \f$ \Omega_{0 scf} \f$ : quintessence scalar field 2*/
  double theta_phi_ini_scf;       /* Angular internal variable for quintessence */
  double y_phi_ini_scf; /* Second potential variable normalized for quintessence*/
    
  double Omega_sig_ini_scf;        /**< \f$ \Omega_{0 scf} \f$ : phantom scalar field 2*/
  double theta_sig_ini_scf;       /* Angular internal variable for phantom scalar field */
  double y_sig_ini_scf; /* Second potential variable normalized for phantom scalar field*/


  double * scf_parameters;  /**< list of parameters describing the scalar field potential */
  int scf_parameters_size;  /**< size of scf_parameters */
  int scf_tuning_index;     /**< index in scf_parameters used for tuning */
  int scf_tuning_index1;
  ...
  int index_bg_rho_scf;       /**< total scalar field energy density */
  int index_bg_rho_phi;       /**< quintessence field energy density */
  int index_bg_rho_sig;       /**< phantom field energy density */
  int index_bg_p_scf;         /**< scalar field pressure */
  int index_bg_p_phi;         /**< quintessence field pressure */
  int index_bg_p_sig;         /**< phantom field pressure */

  int index_bg_Omega_phi_scf;       /**< quintessence field density parameter */
  ...
  int index_bg_Omega_sig_scf;       /**< phantom field density parameter */
  int index_bg_theta_sig_scf; /**< phantom field angular variable */
  int index_bg_y_sig_scf;         /**< phantom field y_1 variable */
  int index_bg_y2_sig_scf;         /**< phantom field y_2 variable */
  ...
  int index_bi_Omega_phi_scf; /**< {B} quintessence field density parameter */
  int index_bi_theta_phi_scf;       /**< {B} quintessence field angular variable */
  int index_bi_y_phi_scf; /**< {B} quintessence field y_1 */
  int index_bi_Omega_sig_scf; /**< {B} phantom field density parameter */
  int index_bi_theta_sig_scf; /**< {B} phantom field angular variable */
  int index_bi_y_sig_scf; /**< {B} phantom field y_1 */
